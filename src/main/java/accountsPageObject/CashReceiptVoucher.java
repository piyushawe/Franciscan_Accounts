...
public class CashReceiptVoucher {
  WebDriver dr;
  String pg="CashReceiptVoucher";
  Utility u= new Utility();
																	  
  public CashReceiptVoucher(WebDriver d)
  {
	  this.dr=d;
	  PageFactory.initElements(d, this); 
  }
  public void openCashReceiptVoucher()
  {
	  ...
	  dr.findElement(By.linkText("Cash Receipt Voucher")).click();
	  dr.switchTo().frame(dr.findElement(By.xpath("//iframe[@src='/AccountManager/CashReceiptVoucher.aspx']")));
  }
