...
public class LedgerReportDetail {
  WebDriver dr;
  Utility u= new Utility();
  String r="LedgerReportDetail";
  ...
  public void openLedgerReportDetail()
  {
	  ...
	  dr.findElement(By.linkText("Ledger Report Detail")).click();
	  dr.switchTo().frame(dr.findElement(By.xpath("//iframe[@src='/Report/Account/LedgerReportDtl.aspx']")));
  }
